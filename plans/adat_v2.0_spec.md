...
| EntrezGeneId                                  | String  | False          | `8514`                                           | Entrez Gene ID(s); pipe-delimited for multi-gene entries (e.g. `"8514\|1234"`). Missing value: empty string. |
...
| EmpiricalHybTemp                | Decimal | NGS-only       | `53.5`                                     | Empirical hybridization temperature from temperature controls                                                                                                                      |
...
| EntrezGeneID                  | EntrezGeneId                                  | Pass through (rename to PascalCase); convert `"N/A"` / `"NA"` to empty string                                                               | Type changed to String (supports pipe-delimited values)    |
...
| Entrez Gene ID                                | EntrezGeneId                                  | Rename to PascalCase; convert `"N/A"` / `"NA"` to empty string | Type String                                                             |
...
| EmpiricalHybTemp                 | EmpiricalHybTemp                | Pass through                                                                    | —                                            |
